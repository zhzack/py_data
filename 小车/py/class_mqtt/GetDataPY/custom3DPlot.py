...
class Custom3DPlot:
    ...
    def plot_ang(filename):
        ...
        for index, row in df.iterrows():
            ...
            degree_result=calculate.process_pdoaToAng(pdoa_first,pdoa_second,pdoa_third)            
        ...
        # 绘制每个结果的折线图
        # (degree_result+degree_offset)%360,x,degree_offset,degree_result,arcsin_degrees1,arcsin_degrees2,arcsin_degrees3
        
        plt.plot(df.index, results, label=['Degree','x','offset','result','arcsin_degrees1','arcsin_degrees2','arcsin_degrees3'])
        
        
        # plt.plot(df.index, results[:,1], label=' Pdoa')
        
        # plt.plot(df.index,results[:,2], label=' arcsin_degrees0')
...
if __name__ == "__main__":
    ...
    # Custom3DPlot.plot_ang("E:/UWB_Share/py_data/merged_output.csv")
    Custom3DPlot.plot_ang("C:/Users/hu.qt/Desktop/t0240618/距离250cm.csv")
    # Custom3DPlot.plot_ang("C:/Users/hu.qt/Desktop/y2024617/不等高180-150cm距离270cm两圈.csv")
    

    # Custom3DPlot.plot_ang("E:/UWB_Share/py_data/ffff.csv")